...
ResultsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    ListView listView;
    ArrayList<com.priyanka.yqlapp.Results> results;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.priyanka.yqlapp.Downloader downloader = new com.priyanka.yqlapp.Downloader(this);
