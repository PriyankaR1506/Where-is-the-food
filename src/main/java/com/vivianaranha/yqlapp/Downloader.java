...
public class Downloader extends AsyncTask<String, Integer, ArrayList> {
    ...
    com.priyanka.yqlapp.ResultsActivity activity;

    public Downloader(com.priyanka.yqlapp.ResultsActivity activity){
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        ArrayList<com.priyanka.yqlapp.Results> resultsArrayList = new ArrayList<com.priyanka.yqlapp.Results>();
